...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	wc.lpszClassName = "OpenGL"; //Especifica el nombre de la clase ventana.
	...
	hwndVentana = CreateWindowEx(NULL,//estilo extendido de ventana
		"OpenGL",//puntero al nombre de la clase registrada *visto arriba*
		"C++ OpenGL",//puntero al nombre de la ventana
